...
if [[ -d ~/.oh-my-zsh ]]; then
    ...
    gum spin --show-output --title="Installing oh-my-zsh..." -- sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" "" --unattended >>$NOCTURNE_LOG/bootstrap.log 2>&1
